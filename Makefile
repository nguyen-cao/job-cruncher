...
crawl_reviews_production:
	cd collectors; scrapy crawl indeed-company-review -a query='Bmo-Financial-Group/reviews?fcountry=CA&lang=en' -a max_items=100 -a search_kw='bmo financial group'
	cd collectors; scrapy crawl indeed-company-review -a query='Cibc/reviews?fcountry=CA&lang=en' -a max_items=100 -a search_kw='cibc'
	cd collectors; scrapy crawl indeed-company-review -a query='Visier/reviews?fcountry=CA&lang=en' -a max_items=100 -a search_kw='visier'
	cd collectors; scrapy crawl indeed-company-review -a query='Rio-Tinto/reviews?fcountry=CA&lang=en' -a max_items=100 -a search_kw='rio tinto'
	cd collectors; scrapy crawl indeed-company-review -a query='Groom-&-Associates/reviews?fcountry=CA&lang=en' -a max_items=100 -a search_kw='groom & associates'
	cd collectors; scrapy crawl indeed-company-review -a query='Amazon.com/reviews?fcountry=CA&lang=en' -a max_items=100 -a search_kw='amazon'
